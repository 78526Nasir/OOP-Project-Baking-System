...
public class ABCBank extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Show Total Customer");
        ...
        jButton2.setText("Show Interest Rate");
        ...
        jButton3.setText("Show Transaction Fees");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(exitButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(95, 95, 95)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int noOfCustomer=accountGUI.getNoOfCustomer();
        displayField.setText("The Bank has "+noOfCustomer+" Customer");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Bank bank = new Bank();
        double transactionFee=bank.getTRANSACTION_FEES();
        displayField.setText("The Transation fess is : "+transactionFee+" Taka");
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Bank bank = new Bank();
        double interestRate=bank.getINTEREST_RATE();
        displayField.setText("The Interest Rate is : "+interestRate+" Taka");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABCBank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
